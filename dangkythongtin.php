    ...
    <div class="part-2-rgister">
        <div class="container bacground-form">
            <div class="container col-md-5 register-form">
                <h5>Đăng ký </h5>
                <form action="created_code.php" class="part-2-form" method="post">
                    <div class="mb-3 mt-3">
                    ...
                    <div>
                        <button type="submit" class="btn col-md-12 text-white btn-warning"
                            value="btnsubmit">lưu</button>
                    </div>
